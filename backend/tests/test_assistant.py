"""
Script para testar a integração com o OpenAI Assistant.
"""
...
ASSISTANT_ID = os.getenv("OPENAI_ASSISTANT_ID_PREMIUM")  # Assistente premium para testes
...
headers = {
    ...
    "OpenAI-Beta": "assistants=v2"  # Usando a versão v2 da API
}

async def test_assistant():
    """Testa a integração com o OpenAI Assistant usando requests diretos."""
    print("Iniciando teste do OpenAI Assistant...")
