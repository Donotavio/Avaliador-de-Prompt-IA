...
export const ResetIcon: React.FC<IconProps> = ({ size = 16, color = 'currentColor', className }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size} 
...
export const LoginIcon: React.FC<IconProps> = ({ size = 16, color = 'currentColor', className }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size} 
...
export const EyeOffIcon: React.FC<IconProps> = ({ size = 16, color = 'currentColor', className }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size} 
